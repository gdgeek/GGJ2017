    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(GDGeek.Lua.VoxelMesh), GDGeekLuaVoxelMeshWrap.__Register);
				...
				translator.DelayWrapLoader(typeof(MyTest), MyTestWrap.__Register);
